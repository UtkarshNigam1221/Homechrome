...
type InventoryRepository interface {
	...
	// CommitOrderStock and ReleaseOrderStock apply one movement to every line of an
	// order, all-or-nothing. quantities maps product ID to amount, so dup lines merge.
