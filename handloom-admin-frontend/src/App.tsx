...
const Dashboard = withSuspense(
  lazy(() => import('./pages/dashboard/DashboardPage').then((m) => ({ default: m.DashboardPage })))
);
const Categories = withSuspense(
  lazy(() => import('./pages/categories').then((m) => ({ default: m.CategoriesPage })))
);
const Products = withSuspense(
  lazy(() => import('./pages/products').then((m) => ({ default: m.ProductsPage })))
);
const Orders = withSuspense(
  lazy(() => import('./pages/orders').then((m) => ({ default: m.OrdersPage })))
);
const OrderDetail = withSuspense(
  lazy(() => import('./pages/orders/OrderDetailPage').then((m) => ({ default: m.OrderDetailPage })))
);
const Customers = withSuspense(
  lazy(() => import('./pages/customers').then((m) => ({ default: m.CustomersPage })))
);
const Artisans = withSuspense(
  lazy(() => import('./pages/artisans').then((m) => ({ default: m.ArtisansPage })))
);
const PricingRules = withSuspense(
  lazy(() => import('./pages/pricing').then((m) => ({ default: m.PricingRulesPage })))
);
const Coupons = withSuspense(
  lazy(() => import('./pages/coupons').then((m) => ({ default: m.CouponsPage })))
);
const Inventory = withSuspense(
  lazy(() => import('./pages/inventory').then((m) => ({ default: m.InventoryPage })))
);
const Analytics = withSuspense(
  lazy(() => import('./pages/analytics').then((m) => ({ default: m.AnalyticsPage })))
);
const Reports = withSuspense(
  lazy(() => import('./pages/reports').then((m) => ({ default: m.ReportsPage })))
);
const Notifications = withSuspense(
  lazy(() => import('./pages/notifications').then((m) => ({ default: m.NotificationsPage })))
);
const BulkOperations = withSuspense(
  lazy(() => import('./pages/bulk').then((m) => ({ default: m.BulkOperationsPage })))
);
const Users = withSuspense(
  lazy(() => import('./pages/settings/UsersPage').then((m) => ({ default: m.UsersPage })))
);
const Settings = withSuspense(
  lazy(() => import('./pages/settings').then((m) => ({ default: m.SettingsPage })))
);
