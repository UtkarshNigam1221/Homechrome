...
const navigation = [
  ...
  { name: 'UTM Links', href: '/utm-links', icon: Link2 },
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          'fixed left-0 top-0 z-50 h-screen w-64 bg-white/95 backdrop-blur-sm border-r border-gray-100 transition-transform duration-300 shadow-sm',
          'lg:hidden',
