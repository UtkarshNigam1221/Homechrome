...
// Brand WhatsApp glyph — heroicons has no WhatsApp logo, so this is hand-rolled.
// Decorative by default (aria-hidden); the surrounding link/label carries the name.
